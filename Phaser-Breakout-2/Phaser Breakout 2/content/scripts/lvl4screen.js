...
RycerzIKsiezniczka.lvl4screen = function(game) {};
...
RycerzIKsiezniczka.lvl4screen.prototype = 
{
	preload : function()
		{
		...
		this.game.load.image('diament', 'content/sprites/diamencik.png');
		this.game.load.audio('music', 'content/auto/music/szmaragdyIDiamenty.mp3');
	...
	create : function()
		...
		var rose = bricks.create(240 + (x * 45), 150 + (y * 65), 'diament');
