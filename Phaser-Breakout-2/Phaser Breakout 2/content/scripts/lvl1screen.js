...
RycerzIKsiezniczka.lvl1screen = function(game) {};
...
RycerzIKsiezniczka.lvl1screen.prototype = 
{
	preload : function()
		{
		...
		this.game.load.image('rose', 'content/sprites/rooze.gif');
		this.game.load.audio('music', 'content/auto/music/bukiet.ogg');
	...
	create : function()
		{
			...
			music.addMarker("MusicMarker",19,200,1,true);
		...
		var rose = bricks.create(240 + (x * 45), 150 + (y * 65), 'rose');
