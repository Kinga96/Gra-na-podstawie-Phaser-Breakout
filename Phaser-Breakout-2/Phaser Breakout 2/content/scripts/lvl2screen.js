...
RycerzIKsiezniczka.lvl2screen = function(game) {};
...
RycerzIKsiezniczka.lvl2screen.prototype = 
{
	preload : function()
		{
		...
		this.game.load.image('hearts', 'content/sprites/serce.gif');
		this.game.load.audio('music', 'content/auto/music/doleczki.ogg');
	...
	create : function()
		{
			...
			music.addMarker("MusicMarker",18,200,1,true);
			...
			for (var y = 0; y < 3; y++)        //to do klockow, przez to bylo 120 bledow
			{
				for (var x = 0; x < 7; x++)
				{
	
		var rose = bricks.create(240 + (x * 45), 150 + (y * 65), 'hearts');
