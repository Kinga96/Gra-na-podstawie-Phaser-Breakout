...
RycerzIKsiezniczka.lvl5screen = function(game) {};
...
RycerzIKsiezniczka.lvl5screen.prototype = 
{
	preload : function()
		{
			this.game.load.atlas('breakout', 'content/sprites/breakout.png', 'content/sprites/breakout.json');
			this.game.load.image('starfield', 'content/sprites/brama.jpg');
			this.game.load.image('paddle', 'content/sprites/tarcza4.png');
			this.game.load.image('ball', 'content/sprites/strzala2.png');
		this.game.load.image('pierscionek', 'content/sprites/pierscionek.png');
		this.game.load.audio('music', 'content/auto/music/KrolowaNocy.ogg');
	...
	create : function()
		{
			...
			//music.addMarker("MusicMarker",12,200,1,true);
			music.addMarker("MusicMarker",53,200,1,true);
			music.play("MusicMarker",0,1,true);
			...
			for (var y = 0; y < 1; y++)    //4    //to do klockow, przez to bylo 120 bledow
			{
				for (var x = 0; x < 1; x++) //15
				{
	
		var rose = bricks.create(300 + (x * 36), 100 + (y * 52), 'pierscionek');
